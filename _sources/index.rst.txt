.. sklmatcher documentation master file, created by
...
**Useful links**:
`Source Repository <https://github.com/scikit-learn-contrib/sklmatcher>`__ |
`Issues & Ideas <https://github.com/scikit-learn-contrib/sklmatcherk/issues>`__ |

This is the documentation for the `sklmatcher` to help at extending
